# Cross-Model Same-Packet Eval - cross_model_same_packet_20260704T020407Z
...
|---|---|---:|---:|---:|---:|---:|
| `hermes_baseline` | `openhermes:latest` | False | 2 | 20 | 0.100 | 0/7 |
...
```text
Answer:
- Provider: Mirror Architecture
- Model: Qwen Tris
- Turns: 500
- Condition B turns passed: unknown
...
```text
Answer: Provider: `qwen-cloud`, Model: `qwen-plus`, Condition B turns passed: `153/153`
