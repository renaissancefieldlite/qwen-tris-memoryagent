# Qwen Tris Three-Condition Iterations - qwen_tris_three_condition_iterations_20260701T040738Z
...
| 6 | `web_recall_0001` | `webarena_browser_memory` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
...
| 9 | `coherence_0002` | `long_session_coherence` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
...
| 12 | `web_recall_0002` | `webarena_browser_memory` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
...
| 21 | `c5b_ssp_0005` | `c5b_500_ssp_memory` | 1 | 6 | True | True | `gated_no_adapter_manifest` |
...
| 24 | `mirror_source_0006` | `mirror_architecture_source_pack` | 0 | 6 | True | True | `gated_no_adapter_manifest` |
...
| 27 | `c5b_ssp_0001` | `c5b_500_ssp_memory` | 1 | 4 | True | True | `gated_no_adapter_manifest` |
| 28 | `external_work_0001` | `external_work_receipts` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 29 | `coherence_0001` | `long_session_coherence` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 30 | `mirror_source_0001` | `mirror_architecture_source_pack` | 3 | 6 | True | True | `gated_no_adapter_manifest` |
| 31 | `swe_recall_0001` | `swe_code_memory` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 32 | `web_recall_0001` | `webarena_browser_memory` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 33 | `c5b_ssp_0002` | `c5b_500_ssp_memory` | 3 | 6 | True | True | `gated_no_adapter_manifest` |
| 34 | `external_work_0002` | `external_work_receipts` | 0 | 5 | True | True | `gated_no_adapter_manifest` |
| 35 | `coherence_0002` | `long_session_coherence` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 36 | `mirror_source_0002` | `mirror_architecture_source_pack` | 3 | 6 | True | True | `gated_no_adapter_manifest` |
| 37 | `swe_recall_0002` | `swe_code_memory` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 38 | `web_recall_0002` | `webarena_browser_memory` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 39 | `c5b_ssp_0003` | `c5b_500_ssp_memory` | 3 | 6 | True | True | `gated_no_adapter_manifest` |
| 40 | `external_work_0003` | `external_work_receipts` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 41 | `coherence_0003` | `long_session_coherence` | 2 | 4 | True | True | `gated_no_adapter_manifest` |
| 42 | `mirror_source_0003` | `mirror_architecture_source_pack` | 3 | 6 | True | True | `gated_no_adapter_manifest` |
| 43 | `swe_recall_0003` | `swe_code_memory` | 1 | 5 | True | True | `gated_no_adapter_manifest` |
| 44 | `web_recall_0003` | `webarena_browser_memory` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 45 | `c5b_ssp_0004` | `c5b_500_ssp_memory` | 3 | 6 | True | True | `gated_no_adapter_manifest` |
...
| 48 | `mirror_source_0005` | `mirror_architecture_source_pack` | 1 | 5 | True | True | `gated_no_adapter_manifest` |
...
| 51 | `c5b_ssp_0007` | `c5b_500_ssp_memory` | 3 | 6 | True | True | `gated_no_adapter_manifest` |
| 52 | `c5b_ssp_0008` | `c5b_500_ssp_memory` | 0 | 6 | True | True | `gated_no_adapter_manifest` |
| 53 | `c5b_ssp_0001` | `c5b_500_ssp_memory` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 54 | `external_work_0001` | `external_work_receipts` | 2 | 4 | True | True | `gated_no_adapter_manifest` |
| 55 | `coherence_0001` | `long_session_coherence` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 56 | `mirror_source_0001` | `mirror_architecture_source_pack` | 0 | 6 | True | True | `gated_no_adapter_manifest` |
| 57 | `swe_recall_0001` | `swe_code_memory` | 2 | 4 | True | True | `gated_no_adapter_manifest` |
| 58 | `web_recall_0001` | `webarena_browser_memory` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 59 | `c5b_ssp_0002` | `c5b_500_ssp_memory` | 0 | 6 | True | True | `gated_no_adapter_manifest` |
| 60 | `external_work_0002` | `external_work_receipts` | 3 | 5 | True | True | `gated_no_adapter_manifest` |
| 61 | `coherence_0002` | `long_session_coherence` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 62 | `mirror_source_0002` | `mirror_architecture_source_pack` | 0 | 6 | True | True | `gated_no_adapter_manifest` |
| 63 | `swe_recall_0002` | `swe_code_memory` | 1 | 4 | True | True | `gated_no_adapter_manifest` |
...
| 66 | `external_work_0003` | `external_work_receipts` | 3 | 4 | True | True | `gated_no_adapter_manifest` |
| 67 | `coherence_0003` | `long_session_coherence` | 2 | 4 | True | True | `gated_no_adapter_manifest` |
| 68 | `mirror_source_0003` | `mirror_architecture_source_pack` | 0 | 6 | True | True | `gated_no_adapter_manifest` |
| 69 | `swe_recall_0003` | `swe_code_memory` | 2 | 5 | True | True | `gated_no_adapter_manifest` |
...
| 72 | `mirror_source_0004` | `mirror_architecture_source_pack` | 1 | 6 | True | True | `gated_no_adapter_manifest` |
...
| 75 | `c5b_ssp_0006` | `c5b_500_ssp_memory` | 1 | 5 | True | True | `gated_no_adapter_manifest` |
...
| 78 | `c5b_ssp_0008` | `c5b_500_ssp_memory` | 1 | 6 | True | True | `gated_no_adapter_manifest` |
...
| 81 | `coherence_0001` | `long_session_coherence` | 3 | 4 | True | True | `gated_no_adapter_manifest` |
...
| 84 | `web_recall_0001` | `webarena_browser_memory` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 85 | `c5b_ssp_0002` | `c5b_500_ssp_memory` | 0 | 6 | True | True | `gated_no_adapter_manifest` |
| 86 | `external_work_0002` | `external_work_receipts` | 0 | 5 | True | True | `gated_no_adapter_manifest` |
...
| 89 | `swe_recall_0002` | `swe_code_memory` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
| 90 | `web_recall_0002` | `webarena_browser_memory` | 0 | 4 | True | True | `gated_no_adapter_manifest` |
...
| 93 | `coherence_0003` | `long_session_coherence` | 3 | 4 | True | True | `gated_no_adapter_manifest` |
| 94 | `mirror_source_0003` | `mirror_architecture_source_pack` | 0 | 6 | True | True | `gated_no_adapter_manifest` |
| 95 | `swe_recall_0003` | `swe_code_memory` | 1 | 5 | True | True | `gated_no_adapter_manifest` |
...
| 99 | `c5b_ssp_0005` | `c5b_500_ssp_memory` | 1 | 6 | True | True | `gated_no_adapter_manifest` |
